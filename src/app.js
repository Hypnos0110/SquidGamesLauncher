const clientId = '1097108978678374473';
 ...
 async function setActivity() {
    ...
    RPC.setActivity({
        details: `SquidGames`,
        state: `Iniciando Evento Especial!`,
        startTimestamp: Date.now(),
        largeImageKey: 'squidgames',
        largeImageText: `SquidGames Ultimate`,
        instance: false,
        buttons: [
            {
                label: `Discord SquidGames`,
                url: `https://discord.io/hypnocommunity`,
            },
            {
                label: `HypnoStudios`,
